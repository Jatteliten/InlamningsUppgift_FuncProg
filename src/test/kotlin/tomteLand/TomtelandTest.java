...
public class TomtelandTest {
    ...
    @Test
    final void getUnderlingsEmptyTest(){
        List<String> list = new ArrayList<>();
        List<String> underlings = tl.getUnderlings("", list);
        assertEquals(underlings.size(), 0);
    }

    @Test
    final void getUnderlingsNonApplicableNameTest(){
        List<String> list = new ArrayList<>();
        List<String> underlings = tl.getUnderlings("Name that doesn't exist", list);
        assertEquals(underlings.size(), 0);
    }
